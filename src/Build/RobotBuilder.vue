  ...
  <div class="content">
    ...
    <div class="middle-row">
      <div class="left part">
        ...
        />
        <button
          @click="selectPreviousLeftArm()"
          class="prev-selector"
        >
          &#9650;
        </button>
        <button
          @click="selectNextLeftArm()"
          class="next-selector"
        >
          &#9660;
        </button>
      ...
      <div class="center part">
        ...
        />
        <button
          @click="selectPreviousTorso()"
          class="prev-selector"
        >
          &#9668;
        </button>
        <button
          @click="selectNextTorso()"
          class="next-selector"
        >
          &#9658;
        </button>
      ...
      <div class="right part">
        ...
        />
        <button
          @click="selectPreviousRightArm()"
          class="prev-selector"
        >
          &#9650;
        </button>
        <button
          @click="selectNextRightArm()"
          class="next-selector"
        >
          &#9660;
        </button>
    ...
    <div class="bottom-row">
      <div class="bottom part">
        ...
        />
        <button
          @click="selectPreviousBase()"
          class="prev-selector"
        >
          &#9668;
        </button>
        <button
          @click="selectNextBase()"
          class="next-selector"
        >
          &#9658;
        </button>
...
export default {
  ...
  methods: {
    addToCart() {
      ...
      const { cost } = robot.head + robot.arms + robot.torso + robot.base;
